    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>Below are some of the resources that we use throughout this app. Note: There is a challenge to make this page better.</p>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="https://gorangajic.hithub.io/react-icons/fa.html" target="_blank">
